...
setIsSubmitting(false);
    ...
    return(
        ...
        <form onSubmit={reportSubmit} id="reportForm" className="flex flex-col w-full">
            ...
            <textarea name="description"
             ...
             <div className="flex flex-col sm:w-4/5 md:w-3/4 lg:w-1/2 mb-2 font-medium items-center gap-4 p-6 border-gray-300 border rounded"
  ...
  ondrop="handleDrop(event)" >
    ...
    <FontAwesomeIcon icon={faUpload} />
            ...
            onChange={handleChange}
            className="w-full h-full text-center border-gray-300 px-4 py-2 border hidden" />
