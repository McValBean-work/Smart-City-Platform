    ...
    return(
        ...
        <Main className='flex p-4 *:sm:p-0 w-full h-full my-12 justify-center items-center'>
            <div className="relative flex min-h-full w-full sm:w-9/12 border-none rounded-2xl">
                <img src={CityView} className="flex rounded-2xl w-full min-h-full object-contain grow" alt="city view photo" />
                <div className="rounded-2xl min-w-full min-h-full p-8 bg-black/70 flex justify-center items-center absolute">
                <div className="flex flex-col text-neutral-100 items-center w-full min-h-full rounded-2x1 justify-around">
