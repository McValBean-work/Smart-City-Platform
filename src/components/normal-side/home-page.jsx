    ...
    return(
        ...
        <Main className='flex p-4 *:sm:p-0 w-full h-full my-12 justify-center items-center'>
            <div className="relative flex min-h-full w-full sm:w-9/12 border-none rounded-2xl">
                <img src={CityView} className="flex rounded-2xl w-full min-h-full object-cover" alt="city view photo" />
                <div className="rounded-2xl min-w-full min-h-full bg-black/70 flex justify-center items-center p-10 absolute">
