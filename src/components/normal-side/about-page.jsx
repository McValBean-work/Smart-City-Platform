...
<div className="flex flex-col min-w-full min-h-full justify-center px-0 sm:px-16 md:px-32 my-8">

            <h2 className="font-semibold text-3xl my-4 ">About Omni City Platform </h2>
            <h3 className="font-medium text-2xl mb-2 mt-4">Our Mission</h3>
            <p className="mb-4">
            ...
            <h3 className="font-medium text-2xl mb-2 mt-4">How It Works</h3>
            <p className="mb-4">
            ...
            <h3 className="font-medium text-2xl mb-2 mt-4">Our Team</h3>
            <p className="mb-4">
            ...
            <h3 className="font-medium text-2xl mb-2 mt-4">Contact Us</h3>
            <p className="mb-4">
